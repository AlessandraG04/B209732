...
_From table 1 we can see that some Health Boards have more houses lacking central heating compared to others, with the highest number attributed to NHS Orkney._
...
**Figure 3:Comparison of ADs and lack of central heating, per 1k population**
```{r, fig.width=12,fig.height=8}
