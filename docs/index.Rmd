...
* housing data: https://www.scotlandscensus.gov.uk/webapi/jsf/tableView/tableView.xhtml (Scotland's Census 2022 - National Records of Scotland, Table UV407 - Central heating)

* population data: https://www.scotlandscensus.gov.uk/webapi/jsf/tableView/tableView.xhtml (Scotland's Census 2022 - National Records of Scotland, Table UV102a - Age (single year) by sex All people)
```{r}
